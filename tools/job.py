...
Every job belongs to exactly one project (workspace | defender | jungle | tide | 13floors | magnet-sweep) and lives
in that
...
Usage:
    ...
    python tools/job.py new     --project 13floors "Title" "Requirements text"
    python tools/job.py new     --project magnet-sweep "Title" "Requirements text"
...
- Project -> Jobs folder is resolved from this script's location (workspace/tools/job.py):
  ...
  13floors   -> <workspace>/../roblox.13floors/Jobs
  magnet-sweep -> <workspace>/../roblox.magnet-sweep/Jobs
...
PROJECTS = {
    ...
    "tide": "../roblox.tide",
    "13floors": "../roblox.13floors",
    "magnet-sweep": "../roblox.magnet-sweep",
}
